...
export default function LiveFailPage() {
  return (
    <div
    ...
    >
      <div className="bg-white dark:bg-white/5 p-12 rounded-[3rem] shadow-2xl max-w-md w-full border border-red-500/10 backdrop-blur-xl">
        ...
        <h1 className="text-3xl font-black mb-4 text-red-500">فشل الاشتراك</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-10 font-bold leading-relaxed">
          نأسف، لم تكتمل عملية الدفع لشراء باقة البث المباشر. يرجى التأكد من
          رصيدك أو اختيار وسيلة دفع أخرى.
        </p>
